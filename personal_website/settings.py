...
SECRET_KEY = 'guy#+i$1(jtku2t@iyya@ef$6#x-gx(+4t=g1q9tx)nt3i$^mf'
...
AUTH_USER_MODEL = 'account.User' # Indicates the model to use in order to represent a User (by default it is 'auth.User')
